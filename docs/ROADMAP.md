...
> 📊 **完整的竞品对比矩阵见 [COMPETITIVE_ANALYSIS.md](./COMPETITIVE_ANALYSIS.md)**（2026-07，基于 v2.7 实际代码 + 11 款竞品最新现状核实）
>
> **核心结论**：NetProbe 在 16 个能力维度中拿下 14 个 ✅，得分 29/34，**居开源竞品首位**。
> 在变更检测、风险评分、JS 分析、中英文情报融合四个维度具备全行业独占优势。

### 能力矩阵速览（详细对比见上方报告）

| | NetProbe | reNgine | ARL | FOFA/Shodan | nuclei |
|---|:---:|:---:|:---:|:---:|:---:|
| 得分（/34） | **29** 🥇 | 25 | 22 | 25 | 4 |
| 全栈管道 | ✅ | ✅ | ✅ | ❌ | ❌ |
| 变更 Diff | ✅独占 | ❌ | ❌ | ⚠️ | ❌ |
